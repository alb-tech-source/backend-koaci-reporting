...
const LOG_PRIORITY: Record<string, ActivityPriority> = {
  ...
  COMPANY_CREATE: "IMPORTANT",
  COMPANY_UPDATE: "IMPORTANT",
  COMPANY_DELETE: "CRITICAL",
  COMPANY_DOCUMENT_UPDATE: "IMPORTANT",
  COMPANY_DOCUMENT_DELETE: "IMPORTANT",
  PROJECT_CREATE: "IMPORTANT",
  PROJECT_UPDATE: "IMPORTANT",
  PROJECT_DELETE: "CRITICAL",
  PROJECT_DOCUMENT_UPDATE: "IMPORTANT",
  PROJECT_DOCUMENT_DELETE: "IMPORTANT",
  PROJECT_REPORTING_DELETE: "IMPORTANT",
  PROJECT_REPORTING_MEDIA_UPDATE: "IMPORTANT",
  PROJECT_REPORTING_MEDIA_DELETE: "IMPORTANT",

  // Normal - 30 hari
  LOGIN_SUCCESS: "NORMAL",
  LOGOUT: "NORMAL",
  DOCUMENT_UPLOAD: "NORMAL",
  COMPANY_DOCUMENT_UPLOAD: "NORMAL",
  PROJECT_DOCUMENT_UPLOAD: "NORMAL",
  PROJECT_REPORTING_CREATE: "NORMAL",
  PROJECT_REPORTING_UPDATE: "NORMAL",
  PROJECT_REPORTING_MEDIA_UPLOAD: "NORMAL",
